...
public class RentACatIntegrationTest {
	...
	public void testGetCatNullNumCats0() {
		...
		//PRECONDITIONS: r has no cats
		// Preconditions: r has no cats
        // Use reflection to access the private method getCat(int)
        try {
	...
	public void testGetCatNumCats3() {
        ...
        // Execution steps: 
        Cat returnedCat = invokeGetCatMethod(r, 2);
	...
	private Cat invokeGetCatMethod(RentACat rentACat, int id) {
        try {
            java.lang.reflect.Method method = RentACat.class.getDeclaredMethod("getCat", int.class);
            method.setAccessible(true);
            return (Cat) method.invoke(rentACat, id);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
